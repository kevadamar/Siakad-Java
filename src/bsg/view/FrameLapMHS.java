...
public class FrameLapMHS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Laporan Data Mahasiswa");
    ...
    private void bLihatLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLihatLaporanActionPerformed
        ...
        try {
            String reportName = koneksi.PathReport + "RepMHS.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameLapMHS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameLapMHS().setVisible(true);
            }
        });
    }
